package com.example.demopizzeria.controller

import com.example.demopizzeria.models.database.ConcentradoEntity
import com.example.demopizzeria.repositories.ConcentradoRepository
...
class MenúController {
    ...
    fun getSaboresPizzas(): List<ConcentradoEntity>{
        ...
        var listaSabores = concentradoRepository.findSabores()
    ...
    fun getTamaños(@RequestParam sabor: String) : ResponseEntity<Any?>
    {
        var listaSabores = concentradoRepository.findTamaños(sabor)
